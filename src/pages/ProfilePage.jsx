    ...
    return (
        <div className="h-screen pt-20">
            ...
            <p className="text-sm text-zinc-400">
              {isUpdatingProfile ? "Загрузка..." : "Нажмите на иконку камеры что бы обновить ваше фото"}
            </p>
          </div>
          ...
          <div className="p-6 mt-6 bg-base-300 rounded-xl">
            <h2 className="mb-4 text-lg font-medium">Информация об аккаунте</h2>
